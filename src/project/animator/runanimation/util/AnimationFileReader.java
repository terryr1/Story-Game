...
public class AnimationFileReader {
   ...
   */
  public <T> T readFile(String fileName, TweenLayerModelBuilder<T> builder) throws
    ...
    while (sc.hasNext()) {
      ...
      switch (command) {
        case "background":
          BackgroundByInfo binfo = backgroundByInfo(sc);
          builder.addBackground(binfo.getR(), binfo.getG(), binfo.getB());
          break;
        case "rectangle":
          ...
          break;
        case "layerRectangle":
          RectangleLayerInfo rlayerinfo = readRectangleLayerInfo(sc);
          builder.addRectangle(
                  rlayerinfo.getName(),
                  rlayerinfo.getX(), rlayerinfo.getY(),
                  rlayerinfo.getWidth(), rlayerinfo.getHeight(),
                  rlayerinfo.getR(), rlayerinfo.getG(), rlayerinfo.getB(),
                  rlayerinfo.getStart(), rlayerinfo.getEnd(), rlayerinfo.getLayer());
          break;
        case "layerOval":
          OvalLayerInfo olayerinfo = readOvalLayerInfo(sc);
          builder.addOval(
                  olayerinfo.getName(),
                  olayerinfo.getX(), olayerinfo.getY(),
                  olayerinfo.getXRadius(), olayerinfo.getYRadius(),
                  olayerinfo.getR(), olayerinfo.getG(), olayerinfo.getB(),
                  olayerinfo.getStart(), olayerinfo.getEnd(), olayerinfo.getLayer());
          break;
        case "oval":
  ...
  private RectangleLayerInfo readRectangleLayerInfo(Scanner sc) throws
          IllegalStateException, InputMismatchException {
    RectangleLayerInfo info = new RectangleLayerInfo();
  ...
  private OvalLayerInfo readOvalLayerInfo(Scanner sc) throws
          IllegalStateException, InputMismatchException {
    OvalLayerInfo info = new OvalLayerInfo();
  ...
  private BackgroundByInfo backgroundByInfo(Scanner sc) throws
          IllegalStateException, InputMismatchException {
    BackgroundByInfo info = new BackgroundByInfo();
  ...
  class RectangleLayerInfo extends RectangleInfo {
  ...
  class OvalLayerInfo extends OvalInfo {
  ...
  class BackgroundByInfo extends Inputable {
    private float r;
    private float g;
    private float b;
